      ...
      <swiper>
        <swiper-slide>
          <div>
            <div class="p-3 bg-white border-bottom">
              <div class="d-flex">
                <router-link tag="button" to="/" class="btn btn-lg flex-1">
                  <i class="iconfont icon-group39"></i>
                  英雄介绍视频
                </router-link>
                <router-link tag="button" to="/" class="btn btn-lg flex-1 ml-2">
                  <i class="iconfont icon-photo-square-outlined"></i>
                  一图识英雄
                </router-link>
              </div>
            ...
            <m-card plain icon="tuijian3" title="出装推荐" class="hero-items">
            ...
            <m-card plain icon="tuijian" title="使用技巧">
              <p class="m-0">{{model.usageTips}}</p>
            </m-card>
            <m-card plain icon="tubiaodansejianyiclose-circleoutline" title="对抗技巧">
              <p class="m-0">{{model.battleTips}}</p>
            </m-card>
            <m-card plain icon="tuijian1" title="团战思路">
              <p class="m-0">{{model.teamTips}}</p>
            </m-card>
            <m-card plain icon="iconfontrenrenguanxi" title="英雄关系">
